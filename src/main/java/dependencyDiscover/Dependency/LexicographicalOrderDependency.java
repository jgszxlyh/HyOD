package dependencyDiscover.Dependency;

import dependencyDiscover.Data.DataFrame;
import dependencyDiscover.MinimalityChecker.LODMinimalityChecker;
...
public class LexicographicalOrderDependency implements AbstractDependency {
     ...
     * 用于单方向的初始化，默认一个方向
     */
    public LexicographicalOrderDependency(String left,String right){
        this.left = new SingleAttributePredicateList(left);
        this.right = new SingleAttributePredicateList(right);
    }
